    ...
    func run(
        ...
        if executable == "gh", arguments.starts(with: ["pr", "view", "42"]),
           arguments.contains("--json") {
            ...
            return result(stdout: #"{"title":"Improve widgets","headRefOid":"\#(headRefOid)","baseRefName":"main","baseRefOid":"abcdef1234567890","url":"https://github.com/acme/widget/pull/42"}"#)
        }
